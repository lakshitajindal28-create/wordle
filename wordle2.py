    ...
    if len(guess) < 5:
        ...
        for s in range(6):
            if real_word[s] == guess_1[s]:
                ...
                print("❕", end = " ")
            elif guess_1[s] not in real_word:
                print("❌", end = " ")
        print("\n")

        if real_word == guess_1:
            print("\033[32mRIGHT!\033[0m")
            break

if real_word != guess_1:
    print("\033[31mOut of Chances!\033[0m")
    print("\033[31mBetter luck next time!!\033[0m\n")
    print("The real word was:", random_word)
